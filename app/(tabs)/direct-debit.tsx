...
function createStyles(c: ReturnType<typeof useThemeColors>) {
  return StyleSheet.create({
    ...
    existingText: { color: '#1A5C30', fontSize: FontSize.sm, flex: 1, fontWeight: FontWeight.medium },
    ...
    deductionInfoText: { flex: 1, fontSize: FontSize.sm, color: '#1A5C30', lineHeight: 20 },
    ...
    noticeText: { flex: 1, fontSize: FontSize.sm, color: '#7F1D1D', lineHeight: 20 },
